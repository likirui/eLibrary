    ...
    <div class="wrapper">
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
          <RouterLink class="navbar-brand" to="/home">eLibrary</RouterLink>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <RouterLink class="nav-link" to="/book">Add Books</RouterLink>
              </li>
              <li class="nav-item">
                <RouterLink class="nav-link" to="/issuance">Book Loans</RouterLink>
              </li>
              <li class="nav-item">
                <RouterLink class="nav-link" to="/return">Return Books</RouterLink>
              </li>
              <li class="nav-item">
                <RouterLink class="nav-link" to="/users">Users</RouterLink>
              </li>
              <li class="nav-item">
                <RouterLink class="nav-link" :to="`/viewuser/${userId}`">My Profile</RouterLink>
              </li>
              <li class="nav-item">
